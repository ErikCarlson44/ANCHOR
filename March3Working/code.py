...
# Pins/freq/SPI baud: shared with lora_hw_config.py (same harness boat + ground).
# -----------------------------------------------------------------------------
try:
