...
def main():
    ...
    def handle_lora_rx(raw):
        """
        Receive any incoming LoRa bytes and log them.
        No command parsing — just accept and print whatever arrives on the air.
        """
        if not raw:
            return
    ...
    while True:
        ...
        # --- LoRa RX: poll for any incoming packets on the configured air parameters ---
        try:
